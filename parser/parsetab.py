...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','parser.py',55),
  ('statement -> expression','statement',1,'p_statement_expr','parser.py',59),
  ...
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','parser.py',73),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','parser.py',77),
  ('expression -> NUMBER','expression',1,'p_expression_number','parser.py',81),
  ('expression -> NAME','expression',1,'p_expression_name','parser.py',85),
]
